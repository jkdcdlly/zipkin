...
import com.twitter.zipkin.storage.hbase.{HBaseDependencyStore, HBaseSpanStore}
...
val spanStore = new HBaseSpanStore(conf)
val dependencies = new HBaseDependencyStore(conf)
